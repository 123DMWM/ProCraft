...
Affected command:
    /BlockDB";
            ...
            vPermissions.Items[(int)Permission.ManageSigns].ToolTipText =
@"Ability to manipulate Signs: adding, removing Signs.
Affected commands:
    /SAdd
    /SRemove";
...
Affected commands:
    ...
    /ZRename";
            ...
            vPermissions.Items[(int)Permission.ManageSpecialZones].ToolTipText =
@"Ability to manipulate denylower, respawnlower, and message zones.
Affected commands:
    /ZAdd
    /ZEdit
    /ZRemove
...
@"Ability to use emotes in chat messages.";
