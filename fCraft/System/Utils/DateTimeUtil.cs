...
namespace fCraft {
    ...
    public static class DateTimeUtil {
        ...
        /// <summary> Returns the number of milliseconds in a TimeSpan, rounded down. </summary>
        public static long ToMilliSeconds(this TimeSpan time)
        {
        ...
        /// <summary> Returns the number of minutes in a TimeSpan, rounded down. </summary>
        public static long ToMinutes(this TimeSpan time)
        {
            return (time.Ticks / TimeSpan.TicksPerMinute);
        }

        /// <summary> Returns the number of hours in a TimeSpan, rounded down. </summary>
        public static long ToHours(this TimeSpan time)
        {
            return (time.Ticks / TimeSpan.TicksPerHour);
        }

        /// <summary> Returns the number of days in a TimeSpan, rounded down. </summary>
        public static long ToDays(this TimeSpan time)
        {
        ...
        [NotNull]
        public static string ToMiniNoColorString( this TimeSpan span ) {
