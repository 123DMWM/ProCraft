...
namespace fCraft {
    ...
    public sealed partial class Player : IClassy {
        ...
        public string ListName {
            get {
				return (Info.Rank.Can(Permission.ReadStaffChat) ? (Info.Rank == RankManager.HighestRank ? "&7+" : "&f-") : " ") + Info.Rank.Color + Name + (Info.DisplayedName.ToLower() != Info.Name.ToLower() ? " &e(&f" + Info.DisplayedName + "&e)" : "");
            }
        }
