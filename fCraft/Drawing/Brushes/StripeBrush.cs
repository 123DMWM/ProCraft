...
namespace fCraft.Drawing {
    ...
    public sealed class StripedBrushFactory : IBrushFactory {
        ...
        const string HelpString = "Striped brush: Fills the area with alternating striped pattern. " +
    ...
    public sealed class StripedBrush : IBrushInstance, IBrush {
        ...
        public StripedBrush( [NotNull] StripedBrush other ) {
